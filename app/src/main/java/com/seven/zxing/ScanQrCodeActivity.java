...
import com.seven.zxing.utils.BitmapUtil;
import com.seven.zxing.utils.IconFont;
...
public class ScanQrCodeActivity extends Activity implements View.OnClickListener, DecoratedBarcodeView.TorchListener {
    ...
    private void init() {
        ...
        IconFont.encodeView("e651", tvTorch);
        IconFont.encodeView("e7d2", tvPicture);
        IconFont.encodeView("e747", tvBack);
    ...
    public void onTorchOn() {
        isTorchOn = true;
        IconFont.encodeView("e650", tvTorch);
    }
